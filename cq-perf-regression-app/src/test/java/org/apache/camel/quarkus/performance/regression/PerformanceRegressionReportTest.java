...
public class PerformanceRegressionReportTest {
    ...
    public void printAllShouldSucceed() throws IOException {
        ...
        sut.setCategoryMeasure("2.10.0", "JVM", 360.0);
        sut.setCategoryMeasure("2.8.0", "JVM", 380.0);
        sut.setCategoryMeasure("2.9.0", "JVM", 390.0);

        sut.setCategoryMeasure("2.10.0", "Native", 1000.0);
        sut.setCategoryMeasure("2.8.0", "Native", 1080.0);
        sut.setCategoryMeasure("2.9.0", "Native", 1090.0);
